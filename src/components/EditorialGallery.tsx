          ...
          {filteredItems.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`${colSpan} relative rounded-3xl overflow-hidden shadow-lg group cursor-pointer bg-stone-900`}
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-transparent opacity-80 group-hover:opacity-95 transition-opacity p-6 sm:p-8 flex flex-col justify-end text-white">
                ...
                <div className="absolute top-4 right-4 w-9 h-9 rounded-full bg-black/50 backdrop-blur-md text-white border border-white/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          >
            ...
            <div className="max-w-5xl max-h-[85vh] flex flex-col items-center">
              ...
              <div className="mt-6 text-center text-white max-w-xl">
                <span className="text-xs uppercase tracking-[0.2em] text-[#E6CA85] block mb-1 font-semibold">
